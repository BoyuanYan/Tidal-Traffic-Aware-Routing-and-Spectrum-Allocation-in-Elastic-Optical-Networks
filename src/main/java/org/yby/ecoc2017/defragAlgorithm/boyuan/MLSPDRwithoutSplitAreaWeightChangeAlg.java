 ...
 * 表示没有区分区域,对全区的业务同样对待的算法.
 */
public class MLSPDRwithoutSplitAreaWeightChangeAlg<E extends EonEdge> extends MLSPDRAlg<E> {
    public MLSPDRwithoutSplitAreaWeightChangeAlg(SimpleWeightedGraph<EonVertex, E> graph, TreeMap<Integer, ServiceAssignment<E>> currentServices, Map<E, Double> occupiedSlotsNum) {
