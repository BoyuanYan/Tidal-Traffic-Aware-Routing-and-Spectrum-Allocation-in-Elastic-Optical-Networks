 ...
 * 没有边权值的改变,但是有区域的划分.
 */
public class MLSPDRwithoutWeightChangeRSA extends MLSPDRSA {
    public MLSPDRwithoutWeightChangeRSA(SimpleWeightedGraph<EonVertex, EonEdge> graph, ArrayList<Service> servicesQueue, ArrayList<Timestamp> servicesOrderedQueue) {
    ...
    protected void handleAllocationFail(Service blockedService, int index) {
        ...
        MLSPDRWithoutWeightChangeAlg<EonEdge> MLSPDRWithoutWeightChangeAlg = new MLSPDRWithoutWeightChangeAlg<>(getGraph(), getCurrentServices(),
