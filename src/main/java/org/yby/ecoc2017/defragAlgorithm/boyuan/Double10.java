 ...
 */
public class Double10 extends MLSPDRSA {
    public Double10(SimpleWeightedGraph<EonVertex, EonEdge> graph, ArrayList<Service> servicesQueue, ArrayList<Timestamp> servicesOrderedQueue) {
