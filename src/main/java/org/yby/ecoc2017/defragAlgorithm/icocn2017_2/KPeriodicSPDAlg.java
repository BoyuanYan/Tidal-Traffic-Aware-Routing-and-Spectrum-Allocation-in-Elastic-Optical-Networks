 ...
 * 用K算法进行重构
 */
public class KPeriodicSPDAlg<E extends EonEdge>  extends ShortestPathDefragmentationAlg<E> {
    public KPeriodicSPDAlg(SimpleWeightedGraph<EonVertex, E> graph, TreeMap<Integer, ServiceAssignment<E>> currentServices) {
