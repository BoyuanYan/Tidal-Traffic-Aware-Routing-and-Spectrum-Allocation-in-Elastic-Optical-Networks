 ...
 */
public class PeriodicSPDAlg<E extends EonEdge>  extends ShortestPathDefragmentationAlg<E> {
    public PeriodicSPDAlg(SimpleWeightedGraph<EonVertex, E> graph, TreeMap<Integer, ServiceAssignment<E>> currentServices) {
